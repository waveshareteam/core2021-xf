...
#define NRST_PIN  5
#define BUSY_PIN  14
LR2021 radio = new Module(NSS_PIN, IRQ_PIN, NRST_PIN, BUSY_PIN, SPI1, SPISettings(SPI_Hz, MSBFIRST, SPI_MODE0));
...
#define RADIOLIB_LORAWAN_JOIN_EUI  0xde588ad0770bcb54
